...
export default function GlobalTickerSearchV4({onOpen,compact=false}:{onOpen?:(symbol:string)=>void;compact?:boolean}){
 ...
 function submit(e:FormEvent){e.preventDefault();const symbol=query.trim().toUpperCase();if(!symbol)return;if(onOpen){onOpen(symbol);setQuery("");return}window.location.assign(`/v4/deep/research/${encodeURIComponent(symbol)}`)}
