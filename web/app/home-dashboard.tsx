...
export default function HomeDashboard({market,rotation,onOpenMarkets,onOpenMacro}:{market:Record<string,Market>;rotation:Rotation|null;onOpenMarkets:()=>void;onOpenMacro:()=>void}){
 ...
 return <>
  <div className="card home-dashboard-card"><div className="section-head"><div><span className="eyebrow">Live overview</span><h2>Market Dashboard</h2></div><button className="text-btn" onClick={onOpenMarkets}>All markets →</button></div>
