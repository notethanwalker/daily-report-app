...
class PrivateScopeContract(unittest.TestCase):
    ...
    def test_opportunities_use_authenticated_tracked_scope_and_shared_market_cache(self):
        ...
        self.assertIn('api("/api/v1/opportunities/tracked")',OPPORTUNITY_UI);self.assertIn('api("/api/v1/opportunities/market-scan?limit=200")',OPPORTUNITY_UI);self.assertNotIn('api("/api/v1/opportunities?limit=200")',OPPORTUNITY_UI)
